...
class InventoryService(val stockRepository: StockRepository) {
    /**
     * Adds or updates stock for a given SKU with validation to ensure stock levels remain
     * consistent. Supports both absolute setting (UPSERT) and relative adjustment (INCREMENT)
     * operations.
     *
